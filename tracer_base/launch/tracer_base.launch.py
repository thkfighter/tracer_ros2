...
def generate_launch_description():
    ...
    #     "is_tracer_mini", default_value='false', description="Scout mini model"
    # )
    ...
    # )
    # is_tracer_mini_arg = DeclareLaunchArgument(
    #     "is_tracer_mini", description="Scout mini model"
    # )
    # simulated_robot_arg = DeclareLaunchArgument(
    #     "simulated_robot", description="Whether running with simulator"
    # )
        ...
        parameters=[
            {
                ...
                #     "odom_topic_name"
                # ),
                # "is_tracer_mini": launch.substitutions.LaunchConfiguration(
                #     "is_tracer_mini"
                # ),
